...
export default function ContactForm() {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      company_name: "",
      phone: "",
      help: "Use Sceptre for my enterprise",
      company_size: "1-10",
      info: "",
    },
  });
    ...
    className="md:flex  justify-center pt-20 px-8">
          ...
          <div
            className="
              ...
              text-gray-500
                    "
          >
            Let&apos;s sell your products faster
          </div>
          ...
          <div className="bg-[#f6f5f4] md:w-4/5 space-y-6 p-4 rounded-lg my-4">
            <div className="flex gap-4 border-b ">
              ...
              One flexible tool for your entire company to ship items, and collaborate.
              </div>
            </div>
            ...
            <div className="flex gap-4 border-b ">
              ...
              <div className=" font-normal pb-2 w-80">
          ...
          >
              ...
              render={({ field }) => (
                <FormItem className="items-center justify-center  w-full">
                  ...
                  >
                    ...
                    <SelectContent>
                      <div className="flex gap-4">
                        <SelectItem value="Use Sceptre for my enterprise">
                        I want to use Sceptre 
                        </SelectItem>
                      </div>
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="text-xs font-light  md:w-3/4 mb-1">
                I agree to Sceptre&apos; sending marketing communications related to Sceptre
              </div>
            </div>
